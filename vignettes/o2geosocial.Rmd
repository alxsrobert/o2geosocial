...
The results presented in this tutorial were generated using only 7,500 iterations to ensure a short run-time for the vignette. We usually recommend longer runs for the chains to converge and to sample from the posterior distribution.
