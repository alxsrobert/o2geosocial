...
config1 <- create_config(data = data1, 
                         n_iter = 7500, #Iteration number: main run
                         n_iter_import = 2000, #Iteration number: short run
