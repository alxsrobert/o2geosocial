...
static SEXP _measlesoutbreaker_cpp_log_like_try(SEXP populationSEXP, SEXP distanceSEXP, SEXP aSEXP, SEXP bSEXP, SEXP gammaSEXP, SEXP spatialSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(cpp_log_like(population, distance, a, b, gamma, spatial));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _measlesoutbreaker_cpp_log_like(SEXP populationSEXP, SEXP distanceSEXP, SEXP aSEXP, SEXP bSEXP, SEXP gammaSEXP, SEXP spatialSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_measlesoutbreaker_cpp_log_like_try(populationSEXP, distanceSEXP, aSEXP, bSEXP, gammaSEXP, spatialSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static SEXP _measlesoutbreaker_cpp_ll_timing_try(SEXP dataSEXP, SEXP paramSEXP, SEXP iSEXP, SEXP custom_functionsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type data(dataSEXP);
    Rcpp::traits::input_parameter< Rcpp::List >::type param(paramSEXP);
...
RcppExport SEXP _measlesoutbreaker_cpp_ll_timing(SEXP dataSEXP, SEXP paramSEXP, SEXP iSEXP, SEXP custom_functionsSEXP) {
    SEXP rcpp_result_gen;
    {
        rcpp_result_gen = PROTECT(_measlesoutbreaker_cpp_ll_timing_try(dataSEXP, paramSEXP, iSEXP, custom_functionsSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static SEXP _measlesoutbreaker_cpp_ll_all_try(SEXP dataSEXP, SEXP configSEXP, SEXP paramSEXP, SEXP iSEXP, SEXP custom_functionsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type data(dataSEXP);
    Rcpp::traits::input_parameter< Rcpp::List >::type config(configSEXP);
...
RcppExport SEXP _measlesoutbreaker_cpp_ll_all(SEXP dataSEXP, SEXP configSEXP, SEXP paramSEXP, SEXP iSEXP, SEXP custom_functionsSEXP) {
    SEXP rcpp_result_gen;
    {
        rcpp_result_gen = PROTECT(_measlesoutbreaker_cpp_ll_all_try(dataSEXP, configSEXP, paramSEXP, iSEXP, custom_functionsSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static int _measlesoutbreaker_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("Rcpp::List(*cpp_log_like)(Rcpp::NumericVector,Rcpp::NumericMatrix,double,double,double,Rcpp::String)");
...
RcppExport SEXP _measlesoutbreaker_RcppExport_registerCCallable() { 
    ...
    R_RegisterCCallable("measlesoutbreaker", "_measlesoutbreaker_cpp_ll_timing", (DL_FUNC)_measlesoutbreaker_cpp_ll_timing_try);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_measlesoutbreaker_cpp_log_like", (DL_FUNC) &_measlesoutbreaker_cpp_log_like, 6},
