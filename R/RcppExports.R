...
cpp_are_possible_ancestors <- function(t_inf, alpha, genotype, gen_tree, cluster, delta, i) {
    .Call(`_o2geosocial_cpp_are_possible_ancestors`, t_inf, alpha, genotype, gen_tree, cluster, delta, i)
}
...
cpp_swap_cases <- function(param, cluster, move_alpha, i) {
    .Call(`_o2geosocial_cpp_swap_cases`, param, cluster, move_alpha, i)
}
